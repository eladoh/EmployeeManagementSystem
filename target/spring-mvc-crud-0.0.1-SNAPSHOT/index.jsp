            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">email</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@abc.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <button class="btn btn-primary" id="emp_add_model_btn">Add</button>
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function(index,item){
            ...
            var deptNameTd = $("<td></td>").append(item.department.deptNam3e);
        ...
        //     delete</button>
            ...
            var delBtn = $("<button></button>").addClass("btn btn-danger btn-sm delete_btn")
                .append($("<span></span>").addClass("glyphicon glyphicon-trash").append("Del"))
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("Page:"+result.extend.pageInfo.pageNum+"; " + "Total pages:"
            + result.extend.pageInfo.pages + "; "+ "Total record:"+result.extend.pageInfo.total + ";")
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result.extend.depts, function () {
                    var optionEle = $("<option></option>").append(this.deptNam3e).attr("value", this.deptId);
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            ...
            show_validate_msg("#empName_add_input", "error", "not a correct username");
            return false;
        }else{
        ...
        if(!regEmail.test(email)){
            //alert("邮箱格式不正确");
            //应该清空这个元素之前的样式
            show_validate_msg("#email_add_input", "error", "not a correct email address");
    ...
    $("#empName_add_input").change(function () {
        ...
        $.ajax({
            ...
            success:function (result) {
                if (result.code == 100){
                    show_validate_msg("#empName_add_input", "success", "username not used")
    ...
    $("#emp_update_btn").click(function(){
        ...
        var regEmail = /^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/;
        if(!regEmail.test(email)){
            show_validate_msg("#email_update_input", "error", "not a correct email address");
            return false;
        }else{
